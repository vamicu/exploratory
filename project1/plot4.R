...
par(mfrow = c(2, 2))
plot(data$datetime,data$Global_active_power, type="l", main = NULL, xlab = "",
	ylab = "Global Active Power (kilowatts)")
plot(data$datetime,data$Voltage, type="l", main = NULL, xlab = "datetime",
	ylab = "Voltage")
...
plot(data$datetime,data$Global_reactive_power, type="l", main = NULL, xlab = "datetime",
